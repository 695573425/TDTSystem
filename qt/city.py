...
china = {
    ...
    '重庆': ['万州区', '涪陵区', '渝中区', '大渡口区', '江北区', '沙坪坝区', '九龙坡区', '南岸区', '北碚区', '綦江区', '大足区', '渝北区', '巴南区', '黔江区', '长寿区', '江津区', '合川区', '永川区', '南川区', '璧山区', '铜梁区', '潼南区', '荣昌区', '梁平县', '城口县', '丰都县', '垫江县', '武隆县', '忠县', '云阳县', '奉节县', '巫山县', '巫溪县', '石柱土家族自治县', '秀山土家族苗族自治县', '酉阳土家族苗族自治县', '彭水苗族土家族自治县', '开州区'],
    ...
    '台湾': ['高雄市', '屏东县',  '台南市', '新竹市', '新竹县', '宜兰县', '基隆市', '苗栗县', '台北市', '新北市', '桃园市', '彰化县', '嘉义县', '嘉义市', '花莲县', '南投县', '台中市', '云林县', '台东县', '澎湖县', '金门县', '连江县', '中国属钓鱼岛'],
    '香港': ['中西区', '湾仔区', '东区', '南区', '油尖旺区', '深水埗区', '九龙城区', '黄大仙区', '观塘区', '荃湾区', '屯门区', '元朗区', '北区', '大埔区', '西贡区', '沙田区', '葵青区', '离岛区'],
    '新疆': ['乌鲁木齐市', '克拉玛依市', '吐鲁番市', '昌吉回族自治州', '博尔塔拉蒙古自治州', '巴音郭楞蒙古自治州', '阿克苏地区', '克孜勒苏柯尔克孜自治州', '喀什地区', '和田地区', '伊犁哈萨克自治州', '塔城地区', '阿勒泰地区', '石河子市', '阿拉尔市', '图木舒克市', '五家渠市', '北屯市', '铁门关市', '双河市', '可克达拉市', '昆玉市', '哈密市'],
    '西藏': ['拉萨市', '日喀则市', '昌都市', '山南市', '那曲地区', '阿里地区', '林芝市', '山南市'],
